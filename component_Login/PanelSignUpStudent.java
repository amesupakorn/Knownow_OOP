        ...
        cmd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                if(txtUser.getText().equals("")){
                    ...
                    File newUser = new File(importmain.locatUserLogin.getAbsolutePath()+"/"+txtUser.getText());
                    if (newUser.exists()){
                        ...
                        try (FileOutputStream fOut = new FileOutputStream(newUser.getAbsolutePath()+"/Body.dat");
                            ...
                            oOut.writeObject(new Account_Student(txtUser.getText(), String.valueOf(txtPass2.getPassword()), txtEmail.getText(), txtPhone.getText()));
