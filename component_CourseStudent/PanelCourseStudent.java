...
public class PanelCourseStudent extends javax.swing.JPanel implements Students{
    String pathimage, pathCourse, courseFolder;
    public PanelCourseStudent() {
        initComponents();
    ...
    public void setImage(String path, String image, String folder){
    ...
    private void initComponents() {
        ...
        dic.setRows(5);
        dic.setBorder(null);
        add(dic, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 320, 220));

        course1.setBackground(new java.awt.Color(247, 247, 247));
        course1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconTeacher/course.png"))); // NOI18N
