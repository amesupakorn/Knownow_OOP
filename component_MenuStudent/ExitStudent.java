...
public class ExitStudent extends javax.swing.JFrame implements Students{
    ...
    private void buttonOutLine12buttonOutLine1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOutLine12buttonOutLine1ActionPerformed
        main_Student now = main_MenuStudent.main_Student.menuStudent;
        now.alreadyToShowCourse = new ArrayList<CourseBox>();
        now.allFileCourse = new ArrayList<File>();
        now.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExitStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExitStudent().setVisible(true);
            }
        });
    }
